        ...
        {complete ? (
          ...
          <form onSubmit={handleSend} className="relative z-10 mt-3 flex items-center gap-2">
            <input
              ...
              className="flex-1 rounded-full bg-white px-4 py-3 text-[14px] text-gray-900 shadow-sm ring-1 ring-black/5 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500 disabled:opacity-60 dark:bg-white/[0.04]